	...
	<body>
		...
		<section class="text-center">
			<section class="image-title">
				...
				<h1 class="heading-1">Fuck Yeah I Zach Walsh</h1>
				<h2 class="heading-3 small">UX + Product Design</h2>
			</section>
		</section>
		<section class="content text-center">
			<div class="wrapper">
				<h2 class="heading-2">Project Highlights</h2>
				<section class="tiles cf">
					...
					<!-- <div class="photowave.php">
						<a href="photowave.php">
							<h4 class="heading-4">Photowave</h4>
							<p class="small">Helping teams visualize progress to themselves and their customers.</p>
						</a>
					</div> -->
